...
require_once("../Conexion/conexionPHP.php");
  ...
  $data3[] = array();
   $data2[] = array();
  $idPeticionPara = $_POST['idPeticionPara'];
    $sql2 = consulta("select * from comentariomuro CM 
INNER JOIN usuario U
ON U.idUsuario = CM.idUsuario
WHERE CM.idComentariolHijoMuro is null  AND CM.idcomentarioMuro='$idPeticionPara'
...
$nombreimg = $v['nombre'];
 $sql22 = consulta("select * from comentariomuro CM
             ...
             $sql2552 = consulta("select Likes,Dislikes from likes where idcomentarioMuro='$idPeticionPara';");
