...
$Comentario = $_POST['Comentario'];
	...
	if (empty($tmpName))
        ...
        if ($carpetaSelect < 0 || $carpetaSelect==undefined || $carpetaSelect==null || $carpetaSelect=="")
		$errors['file'] = 'Ingresa un 4..';
	...
	if ( ! empty($errors)) {
		...
		$data['errors']  = $errors;
           ...
           $fileName2 = md5(microtime());
            ...
            if(consulta("insert into comentariomuro set idUsuario = '$idUsuario', comentario = '$Comentario', FotoMuro='$tmpName',Categoria='$carpetaSelect', nombre='$fileName';")){
                $data['success'] = true;
