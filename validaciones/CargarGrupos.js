 ...
 var apellido2;
  ...
  var idProyecto;
      ...
      $.ajax({
                        ...
                        url: 'validaciones/CargarGrupos.php',
                        ...
                        encode: true
                                ...
                                if (!data[0]) {
                                            alert("No tienes ningun proyecto");
                                } else {
                                      for (var i = 1; i <=data.length; i++) {
                                           tipe=data[i]['tipe'];
                                         subtipe=data[i]['subtipe'];
                                         nombre=data[i]['nombre'];
                                         Img=data[i]['Img'];
                                         idProyec=data[i]['idProyec'];
                                          array=data[i]['array'];
                                          $("#Gupos").append('<div class="main-box clearfix project-box '+tipe+'">\n\
<div class="main-box-body clearfix">\n\
<div class="project-box-header '+subtipe+'">\n\
<div class="name">\n\
  <a class="ProyectoSelect'+i+'" name="'+idProyec+'">\n\
'+nombre+'\n\
</a>\n\
</div>\n\
</div>\n\
<div class="project-box-content">\n\
    <img style="width: 450px;" src="validaciones/'+Img+'">\n\
</div>\n\
<div id="'+idProyec+''+i+'" class="project-box-ultrafooter clearfix">\n\
</div>\n\
</div>\n\
</div>');
                                         
                                       for(var j=0 ; j< array.length ; j++){
                                          nombre2=array[j]['nombre2'];
                                           apellido2=array[j]['apellido2'];
                                            fotoh=array[j]['fotoh'];
                                             idProyecto=array[j]['idProyecto'];
                                            
                                             $("#"+idProyecto+i).append('<img class="project-img-owner" alt="" src="validaciones/'+fotoh+'" data-toggle="tooltip" title="'+nombre2+' '+apellido2+'"/>\n\
<a href="#" class="link pull-right">\n\
<i class="fa fa-arrow-circle-right fa-lg"></i>\n\
</a>');
                                         }
$('.ProyectoSelect'+i).on('click', function () {
     //     var name=$(this).text();
  ...
  var idmuro;
         var formData = {
            ...
            url: 'validaciones/CargarGrupo.php', // the url where we want to POST
            ...
            success: function(data) {
                ...
                if (!data[0]) {
                       alert('ocurrio un problema al buscar los datos');

                } else {
         //INICIONIONIO
                                           nombreproye=data[1]['nombreproye'];
                                           descproye=data[1]['descproye'];
                                            imgproye=data[1]['imgproye'];
                                             idmuro=data[1]['idproye'];
                ...
                <div class="panel-body">\n\
                  ...
                  <div class="form-group form-group-lg">\n\
                    <div class="col-sm-2 control-label">\n\
                        <a data-toggle="modal" data-target="#newimage"><img id="imgproyecto" style="border-radius: 10px; width: 80px; height: 80px; margin-left: 40%;" src="validaciones/'+imgproye+'" class="img-rounded"></a>\n\
                    </div>\n\
                    <div class="col-sm-10">\n\
                  ...
                  <div class="form-group form-group-lg">\n\
                      <label class="col-sm-2 control-label" for="formGroupInputLarge">Nombre proyecto</label>\n\
                          <div class="col-sm-10">\n\
                           <input class="form-control" name="NombreProyecto" value="'+nombreproye+'" type="text" id="formGroupInputLarge" placeholder="'+nombreproye+'">\n\
                          </div>\n\
                  </div>\n\
                  <div class="form-group form-group-lg">\n\
                      <label class="col-sm-2 control-label" for="formGroupInputLarge">Descripción proyecto</label>\n\
                          <div class="col-sm-10">\n\
                             <textarea name="DescProyecto" class="form-control" id="bs-input-descipcionproyeco" placeholder="Cuentanos acerca del proyecto."rows="3">'+descproye+'</textarea>\n\
                          </div>\n\
                  </div>\n\
                      <div class="modal-footer">\n\
...
');
        ...
        ///Termino
            ...
            error: function() {
                $("#popup_content").html("<div>Ocurrio un problema al buscar los datos</div>");
                $("#popup_button").click();
            }
        });
          });
